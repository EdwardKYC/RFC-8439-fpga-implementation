...
HD_PWD='C:/code/RFC-8439-fpga-implementation/AES-Cam-on-PYNQ-Z2-main/AES-Cam-on-PYNQ-Z2-main/AES_SYS/AES_SYS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_SYS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_SYS_wrapper.tcl -notrace
