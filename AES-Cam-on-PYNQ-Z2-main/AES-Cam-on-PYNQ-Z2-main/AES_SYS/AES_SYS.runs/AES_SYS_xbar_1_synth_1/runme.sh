...
HD_PWD='C:/code/RFC-8439-fpga-implementation/AES-Cam-on-PYNQ-Z2-main/AES-Cam-on-PYNQ-Z2-main/AES_SYS/AES_SYS.runs/AES_SYS_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_SYS_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_SYS_xbar_1.tcl
