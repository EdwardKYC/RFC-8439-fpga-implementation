...
################################################################
# This is a generated script based on design: AES_SYS
#
...
\
  ...
  set_property CONFIG.GPIO_BOARD_INTERFACE {btns_4bits} $axi_gpio_0
  ...
  set_property CONFIG.NUM_MI {2} $axi_mem_intercon_1
  ...
  set_property CONFIG.C_ALL_OUTPUTS {1} $axi_gpio_1
  ...
  set_property CONFIG.C_ALL_OUTPUTS {1} $axi_gpio_4
  ...
  connect_bd_intf_net -intf_net axi_gpio_10_GPIO [get_bd_intf_ports sws_2bits] [get_bd_intf_pins axi_gpio_10/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_1_M01_AXI [get_bd_intf_pins axi_mem_intercon_1/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_cdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins ps7_0_axi_periph/M06_AXI] [get_bd_intf_pins axi_gpio_3/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins ps7_0_axi_periph/M07_AXI] [get_bd_intf_pins axi_gpio_4/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins ps7_0_axi_periph/M08_AXI] [get_bd_intf_pins axi_gpio_5/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins ps7_0_axi_periph/M09_AXI] [get_bd_intf_pins axi_gpio_6/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins ps7_0_axi_periph/M10_AXI] [get_bd_intf_pins axi_gpio_7/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M11_AXI [get_bd_intf_pins ps7_0_axi_periph/M11_AXI] [get_bd_intf_pins axi_gpio_8/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M12_AXI [get_bd_intf_pins ps7_0_axi_periph/M12_AXI] [get_bd_intf_pins axi_gpio_9/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M13_AXI [get_bd_intf_pins ps7_0_axi_periph/M13_AXI] [get_bd_intf_pins axi_gpio_10/S_AXI]
  ...
  connect_bd_net -net AES_0_addr [get_bd_pins AES_0/addr] [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net AES_0_data_out [get_bd_pins AES_0/data_out] [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net AES_0_done [get_bd_pins AES_0/done] [get_bd_pins axi_gpio_8/gpio_io_i]
  connect_bd_net -net AES_0_key_gen_Done [get_bd_pins AES_0/key_gen_Done] [get_bd_pins axi_gpio_7/gpio_io_i]
  connect_bd_net -net AES_0_write_en [get_bd_pins AES_0/write_en] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins AES_0/data_in]
  ...
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins axi_gpio_4/gpio_io_o] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins axi_gpio_5/gpio_io_o] [get_bd_pins AES_0/start]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins axi_gpio_6/gpio_io_o] [get_bd_pins AES_0/enc_dec]
  connect_bd_net -net axi_gpio_9_gpio_io_o [get_bd_pins axi_gpio_9/gpio_io_o] [get_bd_pins AES_0/key_gen_start]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_mem_intercon_1/M01_ACLK] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins axi_gpio_8/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M11_ACLK] [get_bd_pins axi_gpio_9/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M12_ACLK] [get_bd_pins AES_0/clk] [get_bd_pins axi_gpio_10/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M13_ACLK]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon_1/M01_ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins axi_gpio_7/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins axi_gpio_8/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M11_ARESETN] [get_bd_pins axi_gpio_9/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M12_ARESETN] [get_bd_pins AES_0/nrst] [get_bd_pins axi_gpio_10/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M13_ARESETN]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins rst_ps7_0_100M/peripheral_reset] [get_bd_pins axi_bram_ctrl_0_bram/rstb]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins xlconcat_1/dout] [get_bd_pins AES_0/key_in]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins axi_bram_ctrl_0_bram/enb]
